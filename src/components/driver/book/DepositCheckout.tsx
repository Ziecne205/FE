...
import type { ParkingLot, VehicleType, PaymentMethod } from '@/types/model'
...
export function DepositCheckout({
  ...
  const lotName = lots.find((l) => l.id === values.parkingLotId)?.name ?? values.parkingLotId
      ...
      <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-2 text-sm">
          <div className="flex justify-between py-1.5 border-b border-gray-100">
            <span className="text-gray-500">Bãi xe</span>
            <span className="font-semibold text-gray-900">{lotName}</span>
          </div>
          <div className="flex justify-between py-1.5 border-b border-gray-100">
